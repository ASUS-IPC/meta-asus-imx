...
SYSTEMD_SERVICE_${PN} = "fs-mount@.service adbd.service mm_keepalive.service"
...
do_install() {
  ...
  install -d ${D}/usr/lib
  cp -pdR ${WORKDIR}/../../../aarch64-poky-linux/tpm2-tss/2.3.2-r0/sysroot-destdir/usr/lib/lib* ${D}/usr/lib
}
